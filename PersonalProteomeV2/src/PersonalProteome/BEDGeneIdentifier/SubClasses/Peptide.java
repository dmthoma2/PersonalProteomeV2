...
public class Peptide {
	...
	/**
	 * Determine if on split checks to see if this peptide occurs on a splice junction within a transcript.  It stores which splice junctions it occurs over in juncs.
	 * 
